    ...
    func requestAlwaysAuthorization() {
        if JailbreakDetectionService.isJailbroken() {
            ...
            if let rootViewController = window?.rootViewController {
                let alertController = UIAlertController(title: "Twoje urządzenie ma złamane zabezpieczenia producenta", message: "W związku z tym niektóre funkcje aplikacji zostały wyłączone", preferredStyle: .alert)
